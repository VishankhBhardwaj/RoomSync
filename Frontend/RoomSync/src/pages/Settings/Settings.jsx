...
const Settings = () => {
  ...
  return (
    <div className='flex flex-col px-20 py-6 border-2 border-green-400 h-[100%] w-[100%] space-y-3 overflow-y-scroll'>
      <div>
      ...
      <div className='text-center bg-[#f3f4f6] shadow-xl rounded-xl  border-2 w-[43%] h-[60px] flex items-center justify-around md:w-[45%]'>
      ...
      <div className='border-2 border-green-400 h-[500px]'>
        {handleComponent()}
      </div>
    </div>
  )
