...
const PcConversation = ({conversation}) => {
  ...
  return (
     <div className="flex flex-col animate__animated animate__fadeIn flex-grow min-h-0 h-full md:h-full bg-white rounded-xl p-2 md:p-4 shadow-md">
          {/* Header */}
          ...
          {/* Input Area */}
          <div className="border-t pt-1  bottom-0 bg-white z-10  sticky">
            <div className="flex items-center gap-2 bg-white">
              <input
                type="text"
              ...
              />
              <button className="bg-[#61a6fa] text-white px-4 py-2 rounded-full text-sm hover:bg-[#83b9fa] transition-all duration-300 hover:shadow-2xl">
                Send
              </button>
            </div>
          </div>
