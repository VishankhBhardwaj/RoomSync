...
const Account = () => {
  return (
    <div className='flex flex-col space-y-10'>
      <div className=' w-[100%] md:h-[350px] p-6 space-y-2 bg-white shadow-xl rounded-xl bg-white'>
        <h1 className='text-2xl bg-white'>Account Information</h1>
        <div className='flex flex-col md:flex-row  md:justify-around bg-white'>
          <div className='flex flex-col space-y-2 md:h-[100px] bg-white'>
        ...
        <div className='flex flex-col space-y-2  bg-white ml-[30]'>
        ...
        <button className='text-white bg-[#70aefa] rounded-xl w-[200px] md:h-[50px] shadow-sm hover:bg-[#70aefa]'>Updata Password</button>
      </div>
      ...
      <div className='w-[100%] md:h-[300px] p-6 space-y-2 bg-white shadow-xl rounded-xl flex flex-col p-6 space-y-2'>
        ...
        <div className="flex flex-col md:flex-row md:justify-between bg-white border-b-2 pb-5">
          ...
          <div className="bg-red-500 hover:bg-red-400 group cursor-pointer px-2 py-2 rounded-xl h-[45px] w-[100px] text-center shadow-md transition-all duration-400">
            <button className='w-[100%] bg-red-500 text-white group-hover:bg-red-400'>Delete</button>
          </div>
        </div>
      </div>
    </div>
